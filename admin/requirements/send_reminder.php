...
try {
    ...
    // Get specific student with incomplete requirements
    $student_query = "
        SELECT 
            a.acc_id,
            a.email,
    ...
    if ($result->num_rows === 0) {
        throw new Exception('Student not found or has no missing requirements');
    }
    ...
    // Email body for individual reminder
    $email_body = "
    <html>
    <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333;'>
        <div style='max-width: 600px; margin: 0 auto; padding: 20px;'>
            <h2 style='color: #ff9800; border-bottom: 2px solid #ff9800; padding-bottom: 10px;'>
                Requirements Submission Reminder
            </h2>
            
            <p>Dear <strong>{$student['full_name']}</strong>,</p>
            
            <p>We hope this message finds you well. This is a friendly reminder regarding your pending enrollment requirements.</p>
            ...
            <div style='background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0;'>
                <h4 style='margin-top: 0; color: #856404;'>Outstanding Requirements:</h4>
                <p style='margin-bottom: 0; color: #856404;'>{$student['missing_requirements']}</p>
            </div>
            
            <div style='margin: 30px 0; padding: 20px; border: 2px solid #17a2b8; border-radius: 5px; background-color: #d1ecf1;'>
                ...
                <ol style='color: #0c5460; margin-bottom: 0;'>
                    ...
                    <li>Submit the missing requirements listed above</li>
            ...
            <div style='margin-top: 30px; padding-top: 20px; border-top: 1px solid #dee2e6; font-size: 14px; color: #6c757d;'>
                <p>Please submit your outstanding requirements at your earliest convenience to avoid any delays in your enrollment process.</p>
